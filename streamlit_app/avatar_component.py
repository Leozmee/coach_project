...
def display_header():
    """Affiche l'en-tête principal avec avatar zen"""
...
def display_chat():
    ...
    with chat_container:
        ...
        for message in st.session_state.messages:
            if message["role"] == "user":
                ...
                # Message bot avec avatar adapté
    ...
    if send_button and user_input.strip():
        ...
        # Déterminer l'humeur de l'avatar selon la réponse
        response_content = response.get("response", "")
        if "exercice" in user_input.lower() or "entraînement" in user_input.lower():
            avatar_mood = "happy"
